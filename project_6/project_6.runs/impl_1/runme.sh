...
HD_PWD='D:/users/ezek/lab6/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topdown.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topdown.tcl -notrace
