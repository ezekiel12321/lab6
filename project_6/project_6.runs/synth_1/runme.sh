...
HD_PWD='D:/users/ezek/lab6/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topdown.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topdown.tcl
